...
define("OPEN_HOUR_BEGIN",       14 * 60 + 0);       # 14:00
define("OPEN_HOUR_END",         20 * 60 + 0);       # 20:00
define("OPEN_HOUR_SLOT",        30);
define("OPEN_HOUR_DAY",         7);
...
function srvc_book_description_4_code($code)
{
    ...
    else if ($code == BOOK_CODE_ERR_BLOCK)
    {
        return "暂停营业，改个日子吧";
    }
    else
